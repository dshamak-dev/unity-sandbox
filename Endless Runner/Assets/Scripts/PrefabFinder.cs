...
public static class PrefabSearchUtility
{
    /// <summary>
...
/*
    void Start()
    {
        ...
        List<GameObject> roadPrefabs = PrefabSearchUtility.FindPrefabsInFolder(
            "Assets/Prefabs/Environment", 
            "Road"
        );
        
        // Example 2: With subfolder search disabled
        List<GameObject> buildingPrefabs = PrefabSearchUtility.FindPrefabsInFolder(
            "Assets/Prefabs/Buildings", 
            "House", 
            false
        );
        
        // Example 3: Get as dictionary
        Dictionary<string, GameObject> prefabDictionary = 
            PrefabSearchUtility.FindPrefabsInFolderAsDictionary(
                "Assets/Prefabs/Vehicles", 
                "Car"
            );
        
        // Example 4: Find and instantiate immediately
        List<GameObject> instantiatedPrefabs = 
            PrefabSearchUtility.FindAndInstantiatePrefabs(
                "Assets/Prefabs/Props", 
                "Tree", 
                this.transform
            );
        
        // Use the found prefabs
    ...
    // Editor menu item for testing
    #if UNITY_EDITOR
    [UnityEditor.MenuItem("Tools/Find Road Prefabs")]
    public static void FindRoadPrefabsMenu()
    {
        var roadPrefabs = PrefabSearchUtility.FindPrefabsInFolder(
            "Assets/Prefabs", 
            "Road"
        );
        
        UnityEditor.Selection.objects = roadPrefabs.ToArray();
    }
    #endif
